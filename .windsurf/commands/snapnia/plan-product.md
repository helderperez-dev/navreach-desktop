...
This process will create these files in `snapnia/product/` directory.
...
- Create `snapnia/product/mission.md` with product vision and strategy
- Create `snapnia/product/roadmap.md` with phased development plan
- Create `snapnia/product/tech-stack.md` documenting all of this product's tech stack choices
...
✅ Product mission: `snapnia/product/mission.md`
✅ Product roadmap: `snapnia/product/roadmap.md`
✅ Product tech stack: `snapnia/product/tech-stack.md`
