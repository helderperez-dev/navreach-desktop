...
- `snapnia/specs/[this-spec]/spec.md`
...
- `snapnia/specs/[this-spec]/spec.md` (if present)
- `snapnia/specs/[this-spec]/planning/requirements.md` (if present)
- `snapnia/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `snapnia/specs/[this-spec]/tasks.md`
