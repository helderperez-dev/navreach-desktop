...
const toolAliases: Record<string, string> = {
  ...
  'browser_inspect_element': 'Inspecting Element',
  'browser_highlight_elements': 'Highlighting',
  'browser_move_to_element': 'Focusing',
  'x_search': 'Searching',
  'x_advanced_search': 'Searching',
  'x_like': 'Liking Post',
  'x_reply': 'Replying',
  'x_post': 'Posting',
  'x_follow': 'Following',
  ...
  'db_get_target_lists': 'Loading Lists',
  'db_create_target_list': 'Creating List',
  'db_create_target': 'Saving Target',
  'db_update_target': 'Updating Target',
  'db_get_mcp_servers': 'Checking Integrations',
  'mcp_list_tools': 'Listing Tools',
  'mcp_call_tool': 'Calling Integration',
  'db_get_api_tools': 'Loading Custom Tools',
  'api_call_tool': 'Calling API',
  ...
  'agent_pause': 'Paused',
  'report_playbook_node_status': 'Updating Step',
