...
import { TargetList } from '@/types/targets';
import { Hash, Check, X, Search } from 'lucide-react';
import { cn } from '@/lib/utils';
import { ScrollArea } from '@/components/ui/scroll-area';
import { Input } from '@/components/ui/input';

interface BulkListSelectionDialogProps {
    open: boolean;
...
export function BulkListSelectionDialog({ open, onOpenChange, lists, targetCount, onConfirm }: BulkListSelectionDialogProps) {
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <Dialog.Description className="text-sm text-muted-foreground mt-1.5">
                                    Add <span className="font-medium text-foreground">{targetCount} contacts</span> to a list.
                                </Dialog.Description>
                            </div>
                        </div>
